#!/usr/bin/env python3
"""
eval_graph_psm_v9.py

Evaluate GraphPSMV9 on the test (or val) split.
...
Example (graph ON):
  CUDA_VISIBLE_DEVICES=0 python eval_graph_psm_v9.py \\
    --run_dir /home/rrame12/Desktop/Research/ASN/runs_psm_v9_on \\
    --data    /home/rrame12/Desktop/Datasets/RestaurantSim_v4_m1_varspk \\
    --out     /home/rrame12/Desktop/Research/ASN/runs_psm_v9_on/eval_test \\
    --split test --batch 4 --save_scenes 6

Example (graph OFF):
  CUDA_VISIBLE_DEVICES=0 python eval_graph_psm_v9.py \\
    --run_dir /home/rrame12/Desktop/Research/ASN/runs_psm_v9_off \\
    --data    /home/rrame12/Desktop/Datasets/RestaurantSim_v4_m1_varspk \\
    --out     /home/rrame12/Desktop/Research/ASN/runs_psm_v9_off/eval_test \\
    --split test --batch 4
"""
...
from train_graph_alltoall_v9 import (
    GraphAllToAllV9,
    compute_si_sdr,
)
...
def main():
    ...
    print("=" * 70)
    print("Evaluate  GraphAllToAllV9")
