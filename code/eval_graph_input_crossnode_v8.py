#!/usr/bin/env python3
"""
eval_graph_input_crossnode_v8.py

Evaluate GraphInputCrossNodeV8 on the test (or val) split.
...
Example (graph ON):
  CUDA_VISIBLE_DEVICES=0 python eval_graph_input_crossnode_v8.py \\
    --run_dir /home/rrame12/Desktop/Research/ASN/runs_input_crossnode_v8_on \\
    --data    /home/rrame12/Desktop/Datasets/RestaurantSim_v4_m1_varspk \\
    --out     /home/rrame12/Desktop/Research/ASN/runs_input_crossnode_v8_on/eval_test \\
    --split test --batch 4 --save_scenes 6

Example (graph OFF):
  CUDA_VISIBLE_DEVICES=0 python eval_graph_input_crossnode_v8.py \\
    --run_dir /home/rrame12/Desktop/Research/ASN/runs_input_crossnode_v8_off \\
    --data    /home/rrame12/Desktop/Datasets/RestaurantSim_v4_m1_varspk \\
    --out     /home/rrame12/Desktop/Research/ASN/runs_input_crossnode_v8_off/eval_test \\
    --split test --batch 4
"""
...
from train_graph_input_crossnode_v8 import (
    GraphInputCrossNodeV8,
    compute_si_sdr,
)
...
def main():
    ...
    print("=" * 70)
    print("Evaluate  GraphInputCrossNodeV8")
